...
<?php
	...
	if (isset($_POST['search'])) {
		...
		echo "<a href='confirmation.php' style='float: right;'>BACK</a>";
		...
		if ($count == 0) {
			...
			while ($row = mysqli_fetch_array($query)) {
				...
				$output .='<tr><td><center>'.$bn.'</center></td><td><center>'.$pn.'</center></td><td>'.$ln.'</td><td><center>'.$fullname.'</center></td><td><a href="confirmationedit.php?id='.$row['id'].'"><center>EDIT</center></a></td><td><a href="confirmationdelete.php?id='.$row['id'].'"><center>DELETE</center></a></td><td><a href="viewcon.php?id='.$row['id'].'"><center>VIEW</center></a></td>';
			}
		}
	}
