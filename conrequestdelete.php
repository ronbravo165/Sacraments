...
<?php
	...
	$result = mysqli_query($con,"SELECT * from conrequest_tbl where id = '$owner_id'");
...
<head>
	...
	<title>SRS - Confirmation Request (Delete)</title>
</head>
<body>
	...
	<form action="conrequestdeleteexec.php" method="post" class="delete-container">
