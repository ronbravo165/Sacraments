...
if (isset($_POST['add'])) {
	include 'connection.php';
		...
		mysqli_query($con,"INSERT INTO communion_tbl (id, bn, pn, ln, fullname, father, mother, birthplace, bday, bmonth, byear, comday, commonth, comyear, godfather, godmother, presider, purpose, priest) VALUES ('$id', '$bn', '$pn', '$ln', '$fullname', '$father', '$mother', '$birthplace', '$bday', '$bmonth', '$byear', '$comday', '$commonth', '$comyear', '$godfather', '$godmother', '$presider', '$purpose', '$priest')");
...
<h1 style="font-family: century gothic; margin-left: 16%;" align="center">Communion Records</h1>
	<input type="button" name="button" value="ADD RECORD" class="button" onclick="document.getElementById('id01').style.display='block'">

	<form method="post" action="searchcom.php">
	...
	<div id="id01" class="modal">
		<form class="modal-content animate" method="post">
			...
			<div class="container1">
				...
				<select name="comday" style="width: 12%;">
					<option>--- Date ---</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
				...
				<select name="commonth" style="width: 13%;">
					<option>--- Month ---</option>
					<option value="January">January</option>
					<option value="February">February</option>
					<option value="March">March</option>
				...
				<input type="text" name="comyear" required class="textbox1" placeholder="Year" style="width: 10%;">

				&nbsp;

				<label>Purpose:</label>
				<input type="text" name="purpose" required class="textbox1" style="width: 21.5%;">
...
<?php
	...
	while($row = mysqli_fetch_array($result)){
		...
		echo "<td><center><a style='text-decoration: none; color: black;' href='communionedit.php?id=".$row['id']."'>&nbsp;&nbsp;Edit&nbsp;&nbsp;</a>&nbsp;<a style='text-decoration: none; color: black;' href='communiondelete.php?id=".$row['id']."'>&nbsp;&nbsp;Delete&nbsp;&nbsp;</a>&nbsp;<a style='text-decoration: none; color: black;' href='viewcom.php?id=".$row['id']."'>&nbsp;&nbsp;View&nbsp;&nbsp;</a></center></td>";
		echo "</tr>";
	}
		echo "</table></center>";
?>
