...
<body>
	...
	<div>
		<center>
			...
			<br><br><br><br><br>
			<p align="center" style="font-family: century gothic; font-size: 30px;">Certificate of Death</p>

			<p align="center" style="font-family: century gothic;">This is to acknowledge the death of </p>

        <h2 align="center" style="font-family: century gothic; text-transform: uppercase;"><?php echo $fullname;?></h2><p align="center" style="font-family: century gothic;"> on <?php echo $decdate;?> at Parokya ni San Nicolas de Tolentino</b> <br>
            <br>
	...
	<center>
		...
		<a href="deceased.php" style="font-family: century gothic; text-decoration: none; color: black;">BACK</a>
