...
if (isset($_POST['add'])) {
	include '../connection.php';
		...
		mysqli_query($con,"INSERT INTO baprequest_tbl (id, fullname, address, birthday) VALUES ('$id', '$fullname', '$address', '$birthday')");
...
<head>
	...
	<title>SRS - Baptismal Request</title>
...
<body>
	...
	<div class="register">
		<form method="post">
			...
			<h2 align="center">Baptismal Request Form</h2>
