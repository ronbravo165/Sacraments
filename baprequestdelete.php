...
<?php
	...
	$result = mysqli_query($con,"SELECT * from baprequest_tbl where id = '$owner_id'");
...
<head>
	...
	<title>SRS - Baptismal Request (Delete)</title>
</head>
<body>
	...
	<form action="baprequestdeleteexec.php" method="post" class="delete-container">
