...
if (isset($_POST['add'])) {
	include 'connection.php';
		...
		mysqli_query($con,"INSERT INTO confirmation_tbl (id, bn, pn, ln, fullname, father, mother, birthplace, bday, bmonth, byear, conday, conmonth, conyear, godfather, godmother, presider, purpose, priest) VALUES ('$id', '$bn', '$pn', '$ln', '$fullname', '$father', '$mother', '$birthplace', '$bday', '$bmonth', '$byear', '$conday', '$conmonth', '$conyear', '$godfather', '$godmother', '$presider', '$purpose', '$priest')");
...
<body>
	...
	<ul>
		...
		<li><a href="confirmation.php" class="nav-menu active">Confirmation</a></li>
	...
	<h1 style="font-family: century gothic; margin-left: 16%;" align="center">Confirmation Records</h1>
	<input type="button" name="button" value="ADD RECORD" class="button" onclick="document.getElementById('id01').style.display='block'">

	<form method="post" action="searchcon.php">
	...
	<div id="id01" class="modal">
		<form class="modal-content animate" method="post">
			...
			<div class="container1">
				...
				<select name="conday" style="width: 12%;">
					<option>--- Date ---</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
				...
				<select name="conmonth" style="width: 13%;">
					<option>--- Month ---</option>
					<option value="January">January</option>
					<option value="February">February</option>
					<option value="March">March</option>
				...
				<input type="text" name="conyear" required class="textbox1" placeholder="Year" style="width: 10%;">

				&nbsp;

				<label>Purpose:</label>
				<input type="text" name="purpose" required class="textbox1" style="width: 21%;">
...
<?php
	...
	while($row = mysqli_fetch_array($result)){
		...
		echo "<td><center><a style='text-decoration: none; color: black;' href='confirmationedit.php?id=".$row['id']."'>&nbsp;&nbsp;Edit&nbsp;&nbsp;</a>&nbsp;<a style='text-decoration: none; color: black;' href='confirmationdelete.php?id=".$row['id']."'>&nbsp;&nbsp;Delete&nbsp;&nbsp;</a>&nbsp;<a style='text-decoration: none; color: black;' href='viewcon.php?id=".$row['id']."'>&nbsp;&nbsp;View&nbsp;&nbsp;</a></center></td>";
		echo "</tr>";
	}
		echo "</table></center>";
?>
