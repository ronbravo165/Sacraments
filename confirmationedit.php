...
<head>
	...
	<title>SRS - Confirmation (Update)</title>
</head>
<body>
	...
	<div class="container-update">
		<h1 align="center">Update Confirmation Record</h1>

		<div class="content-update">
			<form method="post" action="confirmationeditexec.php">
				...
				<label><center>Date of Confirmation:</center></label>
				<center><select name="conday" style="width: 8%;">
					<option><?php echo $conday;?></option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				...
				<select name="conmonth" style="width: 15%;">
					<option><?php echo $conmonth;?></option>
					<option value="January">January</option>
					<option value="February">February</option>
					<option value="March">March</option>
					<option value="April">April</option>
				...
				<input type="text" name="conyear" value="<?php echo $conyear;?>" style="width: 11.5%;"></center><br>
				...
				<center>
					...
					<a href="confirmation.php">BACK</a>
					<br><br>
				</center>
