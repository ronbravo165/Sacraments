...
<?php
	...
	$result = mysqli_query($con,"SELECT * from comrequest_tbl where id = '$owner_id'");
...
<head>
	...
	<title>SRS - Communion Request (Delete)</title>
</head>
<body>
	...
	<form action="comrequestdeleteexec.php" method="post" class="delete-container">
