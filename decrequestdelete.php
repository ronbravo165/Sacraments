...
<?php
	...
	$result = mysqli_query($con,"SELECT * from decrequest_tbl where id = '$owner_id'");
...
<head>
	...
	<title>SRS - Deceased Record Request (Delete)</title>
</head>
<body>
	...
	<form action="decrequestdeleteexec.php" method="post" class="delete-container">
