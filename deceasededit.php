...
<?php
	...
	$result = mysqli_query($con,"SELECT * from deceased_tbl where id = '$owner_id'");
	...
	if (!$result) {
		...
		$byear = $test['byear'];
		$decday = $test['decday'];
		$decmonth = $test['decmonth'];
		$decyear = $test['decyear'];
...
<head>
	...
	<title>SRS - Deceased (Update)</title>
</head>
<body>
	...
	<div class="container-update">
		<h1 align="center">Update Deceased Record</h1>

		<div class="content-update">
			<form method="post" action="deceasededitexec.php">
				...
				<label><center>Date of Death:</center></label>
				<center><select name="decday" style="width: 8%;">
					<option><?php echo $decday;?></option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				...
				<select name="decmonth" style="width: 15%;">
					<option><?php echo $decmonth;?></option>
					<option value="January">January</option>
					<option value="February">February</option>
					<option value="March">March</option>
					<option value="April">April</option>
				...
				<input type="text" name="decyear" value="<?php echo $decyear;?>" style="width: 11.5%;"></center><br>

				

				<label>Caused:</label>
				<input type="text" name="caused" value="<?php echo $caused;?>" style="width: 39.2%;">&nbsp;&nbsp;&nbsp;
