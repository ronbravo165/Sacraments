...
<head>
	...
	<title>SRS - Baptism (Update)</title>
</head>
<body>
	...
	<div class="container-update">
		<h1 align="center">Update Baptismal Record</h1>

		<div class="content-update">
			<form method="post" action="baptismeditexec.php">
				...
				<label><center>Date of Baptism:</center></label>
				<center><select name="bapday" style="width: 8%;">
					<option><?php echo $bapday;?></option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
					<option value="4">4</option>
				...
				<select name="bapmonth" style="width: 15%;">
					<option><?php echo $bapmonth;?></option>
					<option value="January">January</option>
					<option value="February">February</option>
					<option value="March">March</option>
					<option value="April">April</option>
				...
				<input type="text" name="bapyear" value="<?php echo $bapyear;?>" style="width: 11.5%;"></center><br>
